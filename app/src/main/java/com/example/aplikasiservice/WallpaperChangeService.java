...
import com.example.aplikasiservise.R;

import java.io.IOException;


class WallpaperChangeServise extends Service implements Runnable {
    private int wallpaperId[] = {R.drawable.dislike, R.drawable.like};
    private int waktu;
    private int FLAG=0;
    private Thread t;
