    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUnsetBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent mDisable = new Intent(MainActivity.this, com.example.aplikasiservise.WallpaperChangeServise.class);
        ...
        mSetBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mService = new Intent(MainActivity.this, com.example.aplikasiservise.WallpaperChangeServise.class);
